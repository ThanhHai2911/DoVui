            ...
            return GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: isHint
                      ? Colors.amber.withOpacity(0.2) // ← vàng nhạt nếu gợi ý
                      : const Color(0xff2D8CFF),      // ← xanh nếu bình thường
                  border: isHint
                ...
                child: Text(
                  filled.isNotEmpty
                      ? filled       // ← chữ người dùng nhập
                      : hint ?? '', // ← chữ gợi ý mờ
                  style: TextStyle(
                    fontSize: itemSize * 0.45,
                    fontWeight: FontWeight.bold,
                    color: filled.isNotEmpty
                        ? Colors.white                      // ← đã nhập: trắng
                        : Colors.amber.withOpacity(0.8),   // ← gợi ý: vàng mờ
                  ),
                ),
              ),
            );
